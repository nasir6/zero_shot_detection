...
--cls_weight 0.1 --cls_weight_unseen 0.01 --nclass_all 81 --syn_num 250 --val_every 1 \
...
--pretrain_classifier mmdetection/work_dirs/faster_rcnn_r101_fpn_1x/epoch_12.pth \
