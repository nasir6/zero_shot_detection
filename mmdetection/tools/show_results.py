...
checkpoint_file = 'work_dirs/faster_rcnn_r101_fpn_1x/epoch_12.pth'
# checkpoint_file = 'cp_48_17/epoch_12.pth'
syn_weights = '/raid/mun/codes/zero_shot_detection/zsd_coco/checkpoints/coco_65_15_0.6_1_0_1/classifier_best_137.pth'
...
for idx, info in enumerate(img_infos):
    ...
    if info['filename'] in zsd:
        ...
        show_result(f"{img}", result, model.CLASSES, out_file=out_file,show=False, score_thr=score_thr, color_map=color_map)
