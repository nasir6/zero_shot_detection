...
syn_weights = '/raid/mun/codes/zero_shot_detection/zsd_ilsvrc/checkpoints/VOC_new_unseen_cls_1.5/classifier_latest_63.7.pth'
...
for idx, info in enumerate(img_infos):
    ...
    # import pdb; pdb.set_trace()
    out_file = f"det_results/voc_{score_thr}/{img.split('/')[-1]}"
